...
/**
 * GEM ERP design tokens. Semantic colors are driven by CSS variables declared
 * in src/app/globals.css so components reference roles (primary, muted,
 * destructive, ...) instead of raw palette values.
 */
const config: Config = {
  content: ['./src/**/*.{ts,tsx}'],
  theme: {
    extend: {
      ...
      fontFamily: {
        // System stack: no font downloads at build time.
        sans: [
          'ui-sans-serif',
          'system-ui',
          '-apple-system',
